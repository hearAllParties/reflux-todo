...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    render: function () {
	        return (
	            React.createElement("header", {id: "header"}, 
	                ...
	                React.createElement("input", {id: "new-todo", placeholder: "What needs to be done?", onKeyUp: this.onKeyUp})
	            )
	        );
	    }
	});
	...
	var ToDoItem = React.createClass({displayName: "ToDoItem",
	    ...
	    render: function () {
	        return (
	            React.createElement("li", {className: !!this.props.isComplete ? "completed" : ""}, 
	                React.createElement("div", {className: "view"}, 
	                    React.createElement("input", {className: "toggle", type: "checkbox", checked: !!this.props.isComplete, 
	                           onChange: this.handleToggle}), 
	                    React.createElement("label", null, this.props.label), 
	                    React.createElement("button", {className: "destroy", onClick: this.handleDestroy})
	                ), 
	                React.createElement("input", {ref: "editInput", className: "edit"})
	            )
	        )
	    }
	});
	...
	//ToDoWrap
	var ToDoWrap = React.createClass({displayName: "ToDoWrap",
	    ...
	    render: function () {
	        ...
	        return (
	            React.createElement("section", {id: "main", className: list.length > 0 ? "" : "hidden"}, 
	                ...
	                React.createElement("ul", {id: "todo-list"}, 
	                        ...
	                        list.map(function (item) {
	                            return React.createElement(ToDoItem, {label: item.label, isComplete: item.isComplete, id: item.key, 
	                                             key: item.key})
	                        })
	    ...
	    render: function () {
	        return (
	            React.createElement("div", null, 
	                ...
	                React.createElement(ToDoWrap, {list: this.state.list})
	            )
	        )
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	Reflux.connect = __webpack_require__(5);

	Reflux.connectFilter = __webpack_require__(6);

	Reflux.ListenerMixin = __webpack_require__(7);

	Reflux.listenTo = __webpack_require__(8);

	Reflux.listenToMany = __webpack_require__(9);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ListenerMethods = __webpack_require__(11),
	    ListenerMixin = __webpack_require__(7),
...
/***/ function(module, exports, __webpack_require__) {
	...
	Reflux.ListenerMethods = __webpack_require__(11);

	Reflux.PublisherMethods = __webpack_require__(15);

	Reflux.StoreMethods = __webpack_require__(16);

	Reflux.createAction = __webpack_require__(17);

	Reflux.createStore = __webpack_require__(18);
	...
	var _ = Reflux.utils = __webpack_require__(12);
	...
	Reflux.__keep = __webpack_require__(19);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.EventEmitter = __webpack_require__(21);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createStore = __webpack_require__(18),
	    _ = __webpack_require__(12);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ = __webpack_require__(12),
	    ...
	    PublisherMethods = __webpack_require__(15),
